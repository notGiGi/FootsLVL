# create_modern_ui.py
"""
Script que crea todos los archivos necesarios para la UI moderna
"""

import os
import sys 
def create_modern_ui_file():
    """Crea ui/modern_ui.py"""
    
    code = '''# ui/modern_ui.py
"""
...
'''
    ...
    # Crear archivo
    with open("ui/modern_ui.py", "w", encoding="utf-8") as f:
        f.write(code)
    
    print("✓ Creado: ui/modern_ui.py")


def create_app_modern_file():
    """Crea app_modern.py"""
...
def main():
    print("=" * 50)
    print("CREANDO ARCHIVOS UI MODERNA")
    print("=" * 50)
    
    try:
        # 1. Crear ui/modern_ui.py
        create_modern_ui_file()
        
        # 2. Crear app_modern.py
        create_app_modern_file()
