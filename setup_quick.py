...
def download_mun104():
    ...
    try:
        ...
        print(f"⚠️ Error descargando MUN104: {e}")
        print("💡 Se puede descargar después desde la UI")
    return False

def main():
    print("🚀 CONFIGURACIÓN RÁPIDA DE FOOTLAB")
    ...
    # Test dataset loader
    if Path("core/dataset_loader.py").exists():
        download_mun104()
    else:
        print("⚠️ Copiar core/dataset_loader.py del artifact primero")
    
    print("\n🎉 CONFIGURACIÓN COMPLETA")
    print("📋 SIGUIENTES PASOS:")
    print("1. Copiar código de artifacts a:")
